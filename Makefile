...
# Redmine Configuration
	@docker exec redmine_mysql mysql -B -uredmine -predmine redmine -e "INSERT INTO settings (name, value) VALUES ('search_results_per_page','30') ON DUPLICATE KEY UPDATE name='search_results_per_page'='30';"
